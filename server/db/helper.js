...
module.exports = class {
     ...
     */
     create_restaurant_object = (name, description, location, reviews, image_url) => ({
        id: 0,
        name,
        description,
        location,
    ...
    create_restaurant_from_db = (r) => {
        const data = this.create_restaurant_object(r.name, r.description, r.location, r.reviews, this.get_image_uri(r.image_name));
